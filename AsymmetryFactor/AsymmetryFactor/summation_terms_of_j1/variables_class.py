...
class SummationVariables:
    def __init__(self, particle_params, i):
        self.cn = term_c_n(particle_params.ur, particle_params.m, particle_params.x, i)
        self.conj_cn = np.conj(self.cn)
        self.cn1 = term_c_n(particle_params.ur, particle_params.m, particle_params.x, (i + 1))
        ...
        self.dn = term_d_n(particle_params.ur, particle_params.m, particle_params.x, i)
        self.conj_dn = np.conj(self.dn)
        self.dn1 = term_d_n(particle_params.ur, particle_params.m, particle_params.x, (i + 1))
