...
class FrozenWaveAttributes(BeamAttributes):
    ...
    def gn(self, n):
        """
        Calculates the beam shape coefficient of frozen wave beam
    ...
    def Kz_q(self, q_i):
        """
        Calculates the longitudinal wave number
        In the text of the thesis it is called Beta_q
    ...
    def A_q(self, q_i):
        """
        Calculates the qth complex amplitude that weights the qth bessel beam
        that makes up the frozen wave beam
